-- Active: 1747497240252@@127.0.0.1@5432@conservation_db
...
FROM species LEFT JOIN sightings ON species.species_id = sightings.species_id
WHERE sightings.sighting_id IS NULL;

-- Problem 6
SELECT species.common_name, sightings.sighting_time, rangers.name
FROM rangers JOIN sightings ON rangers.ranger_id = sightings.ranger_id JOIN species ON sightings.species_id = species.species_id
